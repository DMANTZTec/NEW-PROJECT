...
public class UserAppController {
    ...
    // this method is responsible to insert records into database
     ...
     public @ResponseBody byte[] displayImg(@RequestParam("id") int id) throws IOException {
      ...
      @RequestMapping(value="/UserApp/showImageNew",method=RequestMethod.GET)
  ...
  // end of the code for filters
     ...
     @RequestMapping(value="/UserApp/productInfo",method=RequestMethod.GET) 
     public @ResponseBody ProductOption productInfo(){
   
    	 System.out.println("entered into productInfo() method of class Controller");
   		
     	 ProductOption productOptionObj=catalogManagerObj.productInfo();
     	 System.out.println("exit from into catalog() method of class Controller");
     ...
     @RequestMapping(value="/UserApp/test",method=RequestMethod.GET) 
     public @ResponseBody String productInfo1(){
